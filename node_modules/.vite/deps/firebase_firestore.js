...
var BloomFilter = class _BloomFilter {
  ...
  Ae(e, t, n) {
    ...
    return 1 === r2.compare(le) && (r2 = new Integer([r2.getBits(0), r2.getBits(1)], 0)), r2.modulo(this.de).toNumber();
  }
...
var __PRIVATE_WatchChangeAggregator = class {
  constructor(e) {
     ...
     * RemoteStore.
     */
    this.$e = new SortedMap(__PRIVATE_primitiveComparator);
  }
  /**
  ...
  Ue(e) {
    for (const t of e.me)
      e.fe && e.fe.isFoundDocument() ? this.We(t, e.fe) : this.Ge(t, e.key, e.fe);
    for (const t of e.removedTargetIds)
      this.Ge(t, e.key, e.fe);
  }
  ...
  ze(e) {
    this.forEachTarget(e, (t) => {
      ...
      switch (e.state) {
        case 0:
          this.He(t) && n.ve(e.resumeToken);
          break;
        case 1:
          n.Be(), n.De || // We have a freshly added target, so we need to reset any state
          // that we had previously. This can happen e.g. when remove and add
          // back a target for existence filter mismatches.
          n.Me(), n.ve(e.resumeToken);
          break;
        case 2:
          n.Be(), n.De || this.removeTarget(t);
          break;
        case 3:
          this.He(t) && (n.Le(), n.ve(e.resumeToken));
          break;
        case 4:
          this.He(t) && // Reset the target and synthesizes removes for all existing
          // documents. The backend will re-add any documents that still
          // match the target before it sends the next global snapshot.
          (this.Je(t), n.ve(e.resumeToken));
          break;
        default:
          fail();
      }
   ...
   */
  Ye(e) {
    const t = e.targetId, n = e.ge.count, r2 = this.Ze(t);
    if (r2) {
      const i = r2.target;
      if (__PRIVATE_targetIsDocumentTarget(i))
        if (0 === n) {
          const e2 = new DocumentKey(i.path);
          this.Ge(t, e2, MutableDocument.newNoDocument(e2, SnapshotVersion.min()));
        } else
          __PRIVATE_hardAssert(1 === n);
      else {
        const r3 = this.Xe(t);
        if (r3 !== n) {
          const n2 = this.et(e), i2 = n2 ? this.tt(n2, e, r3) : 1;
          if (0 !== i2) {
            this.Je(t);
            const e2 = 2 === i2 ? "TargetPurposeExistenceFilterMismatchBloom" : "TargetPurposeExistenceFilterMismatch";
            this.$e = this.$e.insert(t, e2);
          }
          null == ce || ce.nt(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r4, i3) {
            var s, o, _, a, u, c;
            const l2 = {
              localCacheCount: e2,
   ...
   */
  tt(e, t, n) {
    return t.ge.count === n - this.it(e, t.targetId) ? 0 : 2;
  }
  /**
  ...
  it(e, t) {
    ...
    let r2 = 0;
    return n.forEach((n2) => {
      const i = this.ke.rt(), s = `projects/${i.projectId}/databases/${i.database}/documents/${n2.path.canonicalString()}`;
      e.mightContain(s) || (this.Ge(
        t,
        n2,
        /*updatedDocument=*/
        null
  ...
  st(e) {
    ...
    this.qe.forEach((n2, r3) => {
      ...
      if (i) {
        if (n2.current && __PRIVATE_targetIsDocumentTarget(i.target)) {
          ...
          null !== this.Qe.get(t2) || this.ot(r3, t2) || this.Ge(r3, t2, MutableDocument.newNoDocument(t2, e));
        }
        n2.Ce && (t.set(r3, n2.Fe()), n2.Me());
      }
    });
    ...
    const r2 = new RemoteEvent(e, t, this.$e, this.Qe, n);
    return this.Qe = __PRIVATE_mutableDocumentMap(), this.Ke = __PRIVATE_documentTargetMap(), this.$e = new SortedMap(__PRIVATE_primitiveComparator), r2;
  }
  /**
  ...
  We(e, t) {
    ...
    this.je(e).xe(t.key, n), this.Qe = this.Qe.insert(t.key, t), this.Ke = this.Ke.insert(t.key, this._t(t.key).add(e));
  }
  /**
  ...
  Ge(e, t, n) {
    ...
    this.ot(e, t) ? r2.xe(
      ...
      r2.Oe(t)
    ), this.Ke = this.Ke.insert(t, this._t(t).delete(e)), n && (this.Qe = this.Qe.insert(t, n));
  }
  removeTarget(e) {
    this.qe.delete(e);
  }
  ...
  Ze(e) {
    ...
    return t && t.De ? null : this.ke.ut(e);
  }
  /**
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.gn(e).next((e2) => r2.G("collectionGroupIndex", IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.user, e2, n)))));
  }
  updateIndexEntries(e, t) {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    ...
    this.Ii = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.C())
  ...
  runTransaction(e, t, n) {
    ...
    let s;
    return this.Ei.runTransaction(e, r2, i, (r3) => (s = new __PRIVATE_IndexedDbTransaction(r3, this.kr ? this.kr.next() : __PRIVATE_ListenSequence.ae), "readwrite-primary" === t ? this.gi(s).next((e2) => !!e2 || this.pi(s)).next((t2) => {
      if (!t2)
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  So(e, t, n) {
    return this.R_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([r2, i]) => this.connection.So(e, t, n, r2, i)).catch((e2) => {
  ...
  vo(e, t, n, r2) {
    return this.R_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.vo(e, t, n, i, s, r2)).catch((e2) => {
      throw "FirebaseError" === e2.name ? (e2.code === D2.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e2) : new FirestoreError(D2.UNKNOWN, e2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  var r2;
  const i = __PRIVATE_debugCast(e), { request: s, V_: o } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    ...
    return t2.Ie || // Do not include implicit order-bys for aggregate queries.
    (t2.Ie = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)), t2.Ie;
  }(t), n), _ = s.parent;
...
function __PRIVATE_sendWatchRequest(e, t) {
  if (e.O_.Ne(t.targetId), t.resumeToken.approximateByteSize() > 0 || t.snapshotVersion.compareTo(SnapshotVersion.min()) > 0) {
...
function __PRIVATE_sendUnwatchRequest(e, t) {
  e.O_.Ne(t), __PRIVATE_ensureWatchStream(e).l_(t);
}
function __PRIVATE_startWatchStream(e) {
  e.O_ = new __PRIVATE_WatchChangeAggregator({
    getRemoteKeysForTarget: (t) => e.remoteSyncer.getRemoteKeysForTarget(t),
    ut: (t) => e.C_.get(t) || null,
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.O_.Ue(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.O_.Ye(t) : e.O_.ze(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  t.K_(n.onlineState), s.q_) {
    t.U_(s.q_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
  }
}
...
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.W_ = t, /**
     * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
     * observer. This flag is set to true once we've actually raised an event.
     */
    this.G_ = false, this.z_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  U_(e) {
    ...
    let t = false;
    return this.G_ ? this.j_(e) && (this.W_.next(e), t = true) : this.H_(e, this.onlineState) && (this.J_(e), t = true), this.z_ = e, t;
  }
  onError(e) {
    this.W_.error(e);
  }
  ...
  K_(e) {
    this.onlineState = e;
    let t = false;
    return this.z_ && !this.G_ && this.H_(this.z_, e) && (this.J_(this.z_), t = true), t;
  }
  H_(e, t) {
    if (!e.fromCache)
      return true;
    const n = "Offline" !== t;
    return (!this.options.Y_ || !n) && (!e.docs.isEmpty() || e.hasCachedResults || "Offline" === t);
  }
  j_(e) {
    if (e.docChanges.length > 0)
      return true;
    const t = this.z_ && this.z_.hasPendingWrites !== e.hasPendingWrites;
    return !(!e.syncStateChanged && !t) && true === this.options.includeMetadataChanges;
  }
  J_(e) {
    e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.G_ = true, this.W_.next(e);
  }
};
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.ea = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
   ...
   */
  async complete() {
    const e = await __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.ea.id), t = this.na(this.documents);
    for (const e2 of this.queries)
      await __PRIVATE_localStoreSaveNamedQuery(this.localStore, e2, t.get(e2.name));
    return this.progress.taskState = "Success", {
      progress: this.progress,
      ra: this.collectionGroups,
      ia: e
    };
  }
};
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.sa = t, this.oa = null, this.hasCachedResults = false, /**
    ...
    this._a = __PRIVATE_documentKeySet(), /** Document Keys that have local changes */
    this.mutatedKeys = __PRIVATE_documentKeySet(), this.aa = __PRIVATE_newQueryComparator(e), this.ua = new DocumentSet(this.aa);
  }
  /**
   ...
   */
  la(e, t) {
    const n = t ? t.ha : new __PRIVATE_DocumentChangeSet(), r2 = t ? t.ua : this.ua;
  ...
  applyChanges(e, t, n) {
    const r2 = this.ua;
    this.ua = e.ua, this.mutatedKeys = e.mutatedKeys;
    const i = e.ha.k_();
    ...
    }(e2.type, t2.type) || this.aa(e2.doc, t2.doc)), this.Ia(n);
    const s = t ? this.Ta() : [], o = 0 === this._a.size && this.current ? 1 : 0, _ = o !== this.oa;
    if (this.oa = o, 0 !== i.length || _) {
      return {
  ...
  K_(e) {
    return this.current && "Offline" === e ? (
      ...
      (this.current = false, this.applyChanges(
        {
          ua: this.ua,
          ha: new __PRIVATE_DocumentChangeSet(),
   ...
   */
  da(e) {
    return !this.sa.has(e) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
    (!!this.ua.has(e) && !this.ua.get(e).hasLocalMutations);
  }
  /**
   ...
   */
  Ia(e) {
    e && (e.addedDocuments.forEach((e2) => this.sa = this.sa.add(e2)), e.modifiedDocuments.forEach((e2) => {
    }), e.removedDocuments.forEach((e2) => this.sa = this.sa.delete(e2)), this.current = e.current);
  }
  Ta() {
    if (!this.current)
      return [];
    const e = this._a;
    this._a = __PRIVATE_documentKeySet(), this.ua.forEach((e2) => {
      this.da(e2.key) && (this._a = this._a.add(e2.key));
    });
    const t = [];
    return e.forEach((e2) => {
      this._a.has(e2) || t.push(new __PRIVATE_RemovedLimboDocument(e2));
    }), this._a.forEach((n) => {
  ...
  // PORTING NOTE: Multi-tab only.
  Aa(e) {
    this.sa = e.hs, this._a = __PRIVATE_documentKeySet();
    const t = this.la(e.documents);
  ...
  // PORTING NOTE: Multi-tab only.
  Ra() {
    return ViewSnapshot.fromInitialDocuments(this.query, this.ua, this.mutatedKeys, 0 === this.oa, this.hasCachedResults);
  }
};
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.ma = {}, this.fa = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.ga = /* @__PURE__ */ new Map(), /**
     ...
     */
    this.wa = /* @__PURE__ */ new Map(), this.Sa = new __PRIVATE_ReferenceSet(), /** Stores user completion handlers, indexed by User and BatchId. */
    this.ba = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    this.Da = /* @__PURE__ */ new Map(), this.Ca = __PRIVATE_TargetIdGenerator.Bn(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function __PRIVATE_syncEngineListen(e, t) {
  ...
  const s = n.fa.get(t);
  if (s)
    r2 = s.targetId, n.sharedClientState.addLocalQueryTarget(r2), i = s.view.Ra();
  else {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  e.Fa = (t2, n2, r3) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
    let i2 = t3.view.la(n3);
    ...
    (i2 = await __PRIVATE_localStoreExecuteQuery(
      ...
      /* usePreviousResults= */
      false
    ).then(({ documents: e3 }) => t3.view.la(e3, i2)));
  ...
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s.hs), _ = o.la(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r2 && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* updateLimboDocuments= */
    e.isPrimaryClient,
    a
  ...
  return e.fa.set(t, c), e.ga.has(n) ? e.ga.get(n).push(t) : e.ga.set(n, [t]), u.snapshot;
}
async function __PRIVATE_syncEngineUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.fa.get(t), i = n.ga.get(r2.targetId);
  if (i.length > 1)
    return n.ga.set(r2.targetId, i.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void n.fa.delete(t);
...
async function __PRIVATE_syncEngineWrite(e, t, n) {
  ...
  try {
    ...
    r2.sharedClientState.addPendingMutation(e2.batchId), function __PRIVATE_addMutationCallback(e3, t2, n2) {
      ...
      r3 = r3.insert(t2, n2), e3.ba[e3.currentUser.toKey()] = r3;
...
function __PRIVATE_syncEngineApplyOnlineStateChange(e, t, n) {
  ...
  if (r2.isPrimaryClient && 0 === n || !r2.isPrimaryClient && 1 === n) {
    ...
    }(r2.eventManager, t), e2.length && r2.ma.u_(e2), r2.onlineState = t, r2.isPrimaryClient && r2.sharedClientState.setOnlineState(t);
  }
}
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  const r2 = __PRIVATE_debugCast(e);
  r2.sharedClientState.updateQueryState(t, "rejected", n);
  const i = r2.wa.get(t), s = i && i.key;
  if (s) {
    ...
    r2.ya = r2.ya.remove(s), r2.wa.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  ...
  try {
    ...
    const r2 = n.Da.get(e2) || [];
    r2.push(t), n.Da.set(e2, r2);
  } catch (e2) {
...
function __PRIVATE_processUserCallback(e, t, n) {
  ...
  if (i) {
    const e2 = i.get(t);
    e2 && (n ? e2.reject(n) : e2.resolve(), i = i.remove(t)), r2.ba[r2.currentUser.toKey()] = i;
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  e.sharedClientState.removeLocalQueryTarget(t);
  for (const r2 of e.ga.get(t))
    e.fa.delete(r2), n && e.ma.Ma(r2, n);
  if (e.ga.delete(t), e.isPrimaryClient) {
    e.Sa.Vr(t).forEach((t2) => {
      e.Sa.containsKey(t2) || // We removed the last reference for this key
      __PRIVATE_removeLimboTarget(e, t2);
    });
  }
}
function __PRIVATE_removeLimboTarget(e, t) {
  e.pa.delete(t.path.canonicalString());
  const n = e.ya.get(t);
  null !== n && (__PRIVATE_remoteStoreUnlisten(e.remoteStore, n), e.ya = e.ya.remove(t), e.wa.delete(n), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      e.Sa.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
    else if (r2 instanceof __PRIVATE_RemovedLimboDocument) {
      __PRIVATE_logDebug("SyncEngine", "Document no longer in limbo: " + r2.key), e.Sa.removeReference(r2.key, t);
      e.Sa.containsKey(r2.key) || // We removed the last reference for this key
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.ya.get(n) || e.pa.has(r2) || (__PRIVATE_logDebug("SyncEngine", "New document in limbo: " + n), e.pa.add(r2), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.pa.size > 0 && e.ya.size < e.maxConcurrentLimboResolutions; ) {
    const t = e.pa.values().next().value;
    e.pa.delete(t);
    const n = new DocumentKey(ResourcePath.fromString(t)), r2 = e.Ca.next();
    e.wa.set(r2, new LimboResolution(n)), e.ya = e.ya.insert(n, r2), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r2, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.ae));
  }
}
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = [], s = [], o = [];
  r2.fa.isEmpty() || (r2.fa.forEach((e2, _) => {
    o.push(r2.Fa(_, t, n).then((e3) => {
      if (
  ...
  }), await Promise.all(o), r2.ma.u_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.wa.get(t);
  if (r2 && r2.Va)
    return __PRIVATE_documentKeySet().add(r2.key);
  {
    ...
    if (!r3)
      return e2;
    for (const t2 of r3) {
      const r4 = n.fa.get(t2);
      e2 = e2.unionWith(r4.view.ca);
    }
    return e2;
  }
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.va) {
    ...
    n.va = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2)
      __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.va) {
    const e2 = [];
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.Sa.mr(), t3.wa = /* @__PURE__ */ new Map(), t3.ya = new SortedMap(DocumentKey.comparator);
    }(n), n.va = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r2.ga.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r2.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r2.fa.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.va) {
    ...
    for (const e2 of n)
      r2.ga.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        /* keepPersistedTargetData */
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      let s = await t2.xa();
      for (; s; ) {
        const e3 = await i.ta(s);
        e3 && n2._updateProgress(e3), s = await t2.xa();
      }
      ...
      }(e2.localStore, r3), n2._completeWith(o.progress), Promise.resolve(o.ra);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Oa = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.Oa.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Oa.syncEngine), await __PRIVATE_fillWritePipeline(this.Oa.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Oa = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    await super.initialize(e);
    const t = this.Oa.syncEngine;
    ...
    await this.persistence.fi(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Oa.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  createSharedClientState(e) {
...
var __PRIVATE_AsyncObserver = class {
  ...
  next(e) {
    this.observer.next && this.Na(this.observer.next, e);
  }
  error(e) {
    this.observer.error ? this.Na(this.observer.error, e) : __PRIVATE_logError("Uncaught Error in snapshot listener:", e.toString());
  }
  Ba() {
    this.muted = true;
  }
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.La = e, this.serializer = t, /** Cached bundle metadata. */
    this.metadata = new __PRIVATE_Deferred(), /**
     * Internal buffer to hold bundle content, accumulating incomplete element
     * content.
     */
    this.buffer = new Uint8Array(), this.ka = function __PRIVATE_newTextDecoder() {
      return new TextDecoder("utf-8");
    }(), // Read the metadata (which is the first element).
    this.qa().then((e2) => {
      e2 && e2.X_() ? this.metadata.resolve(e2.Z_.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.Z_)}`));
    }, (e2) => this.metadata.reject(e2));
  }
  close() {
    return this.La.cancel();
  }
  async getMetadata() {
  ...
  async qa() {
    ...
    if (null === e)
      return null;
    const t = this.ka.decode(e), n = Number(t);
    isNaN(n) && this.Ka(`length string (${t}) is not valid number`);
    const r2 = await this.$a(n);
  ...
  async Qa() {
    ...
    if (0 === this.buffer.length)
      return null;
    const e = this.Ua();
    e < 0 && this.Ka("Reached the end of bundle when a length string is expected.");
  ...
  async $a(e) {
    for (; this.buffer.length < e; ) {
      await this.Wa() && this.Ka("Reached the end of bundle when more is expected.");
    }
    const t = this.ka.decode(this.buffer.slice(0, e));
    return this.buffer = this.buffer.slice(e), t;
  }
  Ka(e) {
    throw this.La.cancel(), new Error(`Invalid bundle format: ${e}`);
  }
  /**
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, s = await n.vo("BatchGetDocuments", r2, i, t2.length), o = /* @__PURE__ */ new Map();
      s.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.Ga = n.maxAttempts, this.jo = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Ha(e) {
    this.Ga > 0 && this.Ja(e) ? (this.Ga -= 1, this.asyncQueue.enqueueAndForget(() => (this.za(), Promise.resolve()))) : this.deferred.reject(e);
  }
  Ja(e) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r2 = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r2.hs), s = i.la(r2.documents), o = i.applyChanges(
        s,
        /* updateLimboDocuments= */
        false
      );
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    ...
    n.Ba(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    this.Ya = Promise.resolve(), // A list of retryable operations. Retryable operations are run in order and
    // retried with backoff.
    this.Za = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
    this.Xa = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.eu = [], // visible for testing
    this.tu = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.nu = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.ru = false, // List of TimerIds to fast-forward delays for.
  ...
  enqueueAndForgetEvenWhileRestricted(e) {
    this.ou(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this._u(e);
  }
  enterRestrictedMode(e) {
    if (!this.Xa) {
      this.Xa = true, this.ru = e || false;
      const t = getDocument();
  ...
  enqueue(e) {
    ...
    return this._u(() => this.Xa && this.ru ? Promise.resolve() : (e().then(t.resolve, t.reject), t.promise)).then(() => t.promise);
  }
  enqueueRetryable(e) {
  ...
  async au() {
    if (0 !== this.Za.length) {
      ...
      this.Za.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  _u(e) {
    const t = this.Ya.then(() => (this.nu = true, e().catch((e2) => {
      this.tu = e2, this.nu = false;
      const t2 = (
        /**
    ...
    }).then((e2) => (this.nu = false, e2))));
    return this.Ya = t, t;
  }
  enqueueAfterDelay(e, t, n) {
    this.ou(), // Fast-forward delays for timerIds that have been overriden.
    this.iu.indexOf(e) > -1 && (t = 0);
    const r2 = DelayedOperation.createAndSchedule(this, e, t, n, (e2) => this.uu(e2));
    return this.eu.push(r2), r2;
  }
  ou() {
    this.tu && fail();
  }
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  fu(e) {
    return __PRIVATE_createError(e, this.settings.methodName, this.settings.gu || false, this.path, this.settings.pu);
  }
...
function __PRIVATE_parseSetData(e, t, n, r2, i, s = {}) {
  const o = e.yu(s.merge || s.mergeFields ? 2 : 0, t, n, i);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Tu)
      throw 1 === e.Tu ? e.fu(`${this._methodName}() can only appear at the top level of your update data`) : e.fu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.wu.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayUnionTransformOperation(n);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.wu.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return this === e;
...
var __PRIVATE_NumericIncrementFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericIncrementTransformOperation(e.serializer, toNumber(e.serializer, this.Su));
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  const o = e.yu(1, t, n), _ = [__PRIVATE_fieldPathFromArgument$1(t, r2, n)], a = [i];
  if (s.length % 2 != 0)
...
function __PRIVATE_parseQueryValue(e, t, n, r2 = false) {
  return __PRIVATE_parseData(n, e.yu(r2 ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Tu))
        throw t2.fu(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.fu(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n))
        throw t2.fu(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
...
function __PRIVATE_parseObject(e, t) {
  ...
  return isEmpty(e) ? (
    ...
    const i = __PRIVATE_parseData(r2, t.du(e2));
    null != i && (n[e2] = i);
  }), {
    mapValue: {
      fields: n
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (!__PRIVATE_looksLikeJsonObject(n) || !function __PRIVATE_isPlainObject(e2) {
    ...
    throw "an object" === r2 ? t.fu(e + " a custom object") : t.fu(e + " " + r2);
  }
}
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r3) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerListen(await __PRIVATE_getEventManager(e2), s2)), () => {
      i2.Ba(), e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerUnlisten(await __PRIVATE_getEventManager(e2), s2));
    };
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.3.0", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(w2, "4.3.0", "esm2017");
}();
export {
